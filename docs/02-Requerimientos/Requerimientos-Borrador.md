...
**Descripción**: Concentra el flujo de ocupación de los cupos del centro. Contempla la asignación automática de turnos, la reserva de clases y la administración de las listas de espera mediante notificaciones con temporizador.
...
#### Épica 6: Dashboard y Gerencia (Uso del Administrador)
...
### Épica 1: Gestión de Usuarios y Accesos (aprox. 35 puntos)
...
### Épica 2: Gestión de Actividades (aprox. 40 puntos)
...
### Épica 3: Gestión de Reservas y Listas de Espera (aprox. 50 puntos)
...
### Épica 4: Cancelaciones y Créditos (aprox. 24 puntos)
...
### Épica 5: Cobros y Pagos (aprox. 36 puntos)
...
### Épica 6: Dashboard y Gerencia (aprox. 25 puntos)
- RF-17 Gestión de personal: 8 puntos (16 h)
- RF-18 Panel de métricas: 17 puntos (34 h)

### Requerimientos No Funcionales y tareas transversales (aprox. 20 puntos)
- Responsive, migración de datos, identidad visual, pruebas de capacidad, documentación: 20 puntos (40 h)

**Total estimado:** 230 puntos ≈ 460 horas de trabajo efectivo (sincrónico, no incluye tiempos de espera, reuniones, ni aprendizaje).